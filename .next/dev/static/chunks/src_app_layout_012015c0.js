...
function RootLayout(t0) {
    ...
    if ($[0] !== "de72d68536604fca15f12beb53f0953ad0acf889efd19feff5b0bda44406c711") {
        for(let $i = 0; $i < 19; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "de72d68536604fca15f12beb53f0953ad0acf889efd19feff5b0bda44406c711";
    }
    const { children } = t0;
    ...
    let t2;
    if ($[3] !== isAccessActive || $[4] !== pathname) {
        t2 = ({
    ...
    const t4 = `${getButtonStyle("/nosotros")} px-7 py-2.5 rounded-full text-[11px] font-black transition-all active:scale-95 uppercase tracking-widest`;
    let t5;
    if ($[7] !== t4) {
    ...
    const t6 = `${getButtonStyle("/login")} px-7 py-2.5 rounded-full text-[11px] font-black transition-all active:scale-95 uppercase tracking-widest`;
    let t7;
    if ($[9] !== t6) {
